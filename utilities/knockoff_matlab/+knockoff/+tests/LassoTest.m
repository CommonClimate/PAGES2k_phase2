classdef LassoTest < knockoff.tests.KnockoffTestCase
    ...
    methods (Test)
        ...
        function testOrthonormal(self)
            ...
            betaLS = X'*y;
            nlambda = 10000;
            lambdaMax = knockoff.private.lassoMaxLambda(X, y, nlambda);
        ...
        function testPermutationInvariance(self)
            ...
            nlambda = 10000;
            lambdaMax = knockoff.private.lassoMaxLambda(X, y, nlambda);
            lambdaMaxPerm = knockoff.private.lassoMaxLambda(X(:,I), y, nlambda);
            self.verifyAlmostEqual(lambdaMax(I), lambdaMaxPerm, 1e-3);
