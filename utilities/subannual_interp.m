function [X,t,Xr,tr,mr,yr,npy,mRes,dt] = subannual_interp(t_raw,X_raw,mcorr,mRes)
%   [X,t,Xr,tr,mr,yr,npy,dt] = subannual_interp(t_raw,X_raw,mcorr,mRes)
%           interpolates a subannually-resolved time series onto a regular time grid
%
...
npy = 12/mRes; % number of samples per year in interpolated series
